    ...
    styles(style_id) {
        ...
        return (`
                    [data-i=${style_id}] {
                        ...
                        --bg-color-resolved: oklch( from var(--bg-color) var(${__BOX_L_FACTOR}, var(--bromo-factor-box-l-default)) var(--box-c-factor, var(--bromo-factor-box-c-default)) h);
                    ...
                    [data-theme="dark"] {
                        [data-i=${style_id}] {
                            ...
                            ${__BOX_L_FACTOR}: var(${__BOX_L_FACTOR_DARK}, var(--bromo-factor-box-l-default)) !important;
                        }
                    }
        `)
    }
